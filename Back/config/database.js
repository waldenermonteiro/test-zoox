...
module.exports = {
  ...
  */
  ...
  mongodb: {
    client: "mongodb",
    connectionString: Env.get("DB_CONNECTION_STRING", 'mongodb://jrmonteiro:teste123@localhost:27017'),
    connection: {
      host: Env.get("DB_HOST", "localhost"),
      port: Env.get("DB_PORT", 27017),
      username: Env.get("DB_USER", "jrmonteiro"),
      password: Env.get("DB_PASSWORD", "teste123"),
      database: Env.get("DB_DATABASE", "testZoox"),
      options: {
